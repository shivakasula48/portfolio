...
function initScrollEffects() {
    ...
    const animatedElements = document.querySelectorAll(
        '.project-card, .skill-category, .certification-card, .experience-item, .education-item, .about-content, .contact-content'
    );
...
function initContactForm() {
    ...
    formFields.forEach(field => {
        ...
        field.addEventListener('focus', function() {
            ...
            this.style.boxShadow = '0 0 0 3px rgba(34, 211, 238, 0.2)';
...
function submitContactForm(name, email, subject, message) {
    ...
    setTimeout(() => {
        try {
            ...
            const mailtoLink = `mailto:shivakasula10@gmail.com?subject=${encodeURIComponent(subject)}&body=${encodeURIComponent(
            ...
            showNotification('Thank you for your message! Your email client should open with the pre-filled message.', 'success');
            
        } catch (error) {
            console.error('Error submitting form:', error);
            showNotification('There was an error processing your message. Please try again or contact directly via email.', 'error');
        } finally {
            // Reset button
...
// Enhanced copy to clipboard functionality for contact info
function initCopyToClipboard() {
    ...
    function fallbackCopy(text) {
        ...
        try {
            ...
            showNotification('Unable to copy to clipboard. Please select and copy manually.', 'error');
        }
